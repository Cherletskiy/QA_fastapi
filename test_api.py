...
#         self.base_url = base_url.rstrip("/")  # Убираем слэш из базового URL
...
#             f"{self.base_url}/api/v1/questions/{question['id']}"
#         )
#         assert response.status_code == 200
...
#
#         response = await self.client.post(
#             f"{self.base_url}/api/v1/questions/{question_id}/answers",
#             json=answer_data
#         )
...
#         # 2. Получение ответа
#         response = await self.client.get(
#             f"{self.base_url}/api/v1/answers/{answer['id']}"
#         )
#         assert response.status_code == 200
...
#         }
#         response = await self.client.post(
#             f"{self.base_url}/api/v1/questions/9999/answers",
#             json=answer_data
#         )
...
#         response = await self.client.get(
#             f"{self.base_url}/api/v1/questions/9999"
#         )
#         assert response.status_code == 404
#         print("404 ошибка для несуществующего вопроса")
#
